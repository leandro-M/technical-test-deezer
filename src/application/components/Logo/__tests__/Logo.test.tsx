...
describe('Logo Component', () => {
  test('should render the SVG logo correctly', () => {
    render(<Logo />);
    ...
    expect(svgElement).toHaveAttribute('width', '127');
    expect(svgElement).toHaveAttribute('height', '20');
    expect(svgElement).toHaveAttribute('fill', 'none');
  });

  test('should have the correct path in the SVG', () => {
    render(<Logo />);

    const pathElement = screen.getByTestId('logo-path');
